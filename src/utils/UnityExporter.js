...
export class UnityExporter {
  ...
  async saveToFiles() {
    ...
    if (this.exportData.meshes.length > 0) {
      ...
      fs.writeFileSync(
        meshFile,
        JSON.stringify(this.exportData.meshes, null, 2),
      );
      console.log(
        `✅ Saved ${this.exportData.meshes.length} meshes to: ${meshFile}`,
      );
    }
    ...
    if (this.exportData.materials.length > 0) {
      ...
      fs.writeFileSync(
        matFile,
        JSON.stringify(this.exportData.materials, null, 2),
      );
      console.log(
        `✅ Saved ${this.exportData.materials.length} materials to: ${matFile}`,
      );
    }
    ...
    if (this.exportData.gameObjects.length > 0) {
      ...
      fs.writeFileSync(
        objFile,
        JSON.stringify(this.exportData.gameObjects, null, 2),
      );
      console.log(
        `✅ Saved ${this.exportData.gameObjects.length} game objects to: ${objFile}`,
      );
    }
    ...
    if (this.exportData.enemyTypes.length > 0) {
      ...
      fs.writeFileSync(
        enemyFile,
        JSON.stringify(this.exportData.enemyTypes, null, 2),
      );
      console.log(
        `✅ Saved ${this.exportData.enemyTypes.length} enemy types to: ${enemyFile}`,
      );
    }
    ...
    if (this.exportData.weaponTypes.length > 0) {
      ...
      fs.writeFileSync(
        weaponFile,
        JSON.stringify(this.exportData.weaponTypes, null, 2),
      );
      console.log(
        `✅ Saved ${this.exportData.weaponTypes.length} weapon types to: ${weaponFile}`,
      );
    }
    ...
    if (this.exportData.environments.length > 0) {
      ...
      fs.writeFileSync(
        envFile,
        JSON.stringify(this.exportData.environments, null, 2),
      );
      console.log(
        `✅ Saved ${this.exportData.environments.length} environments to: ${envFile}`,
      );
    }
